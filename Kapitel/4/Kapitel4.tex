...
\begin{figure}[htp]
	...
	\end{center}
\end{figure}
Die Datenbank wurde um die Tabellen "'members"' und "'login-attemps"' erweitert. Die Datenbanktabelle "'members"' enthält die selbsterklärenden Attribute "'ID"',"'username"',"'email"',"'password"' und "'salt"'. Die Tabelle "'login-attemps"' besitzt die Attribute "'USER\_ID"' und "'time"'. Die genaue Funktionalität des Logins wird nachfolgend in \fullref{Login} erläutert.
