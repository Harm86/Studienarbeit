...
Damit die Zentraleinheit die Anforderungen die in der \nameref{Planung} festgelegt wurden erfüllt, wurde folgende Software auf der Zentraleinheit vorinstalliert:
\begin{description}
	\item[Apache2:] \hfill \\
	Als Webserver zur Darstellung der \fullref{Webseite} wurde ein Apache2 installiert.
	%AUSFÜHREN MIT QUELLE WAS IST APACHE2 etc.
	\item[MySQL:] \hfill \\
	Eine MySQL Datenbankserver wurde auf der Zentraleinheit vorinstalliert, dieser dient wie in Kapitel \nameref{Datenbank} vorgestellt, dem Sammeln der Sensordaten.
