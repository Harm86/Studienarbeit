...
\usepackage{bbding}
\usepackage{listings}
%TODO: Abstimmen, welche farben gewählt werden sollen
\lstset{
	commentstyle=\color{mygray},
	escapeinside={<@}{@>},
	keywordstyle=\color{blue},
	texcl=true}
%So kann man eigene Schlüsselwörter hinzufügen
\lstset{emph={%  
		self%
...
Die vorliegende Arbeit behandelt das Thema Entwicklung eines Sensorknotens für IoT. Die Idee ist eine Umgebung zu erstellen, in der mehrere Sensorknoten kommunizieren und Messwerte melden. Die Problemstellung wurde gelöst indem es eine Zentraleinheit gibt, an die die Sensorknoten ihre Messwerte melden. Als Hardwaregrundlage werden mehrere Raspberry Pis verwendet, die als unabhängige Sensorknoten arbeiten und ein Raspberry Pi, der als Zentraleinheit fungiert. Die Software der Sensorknoten ist in Phyton realisiert. Damit die Daten der Sensorknoten verwendet werden können, werden sie in einer MySQL-Datenbank abgelegt. Dargestellt werden die einzelnen Messwerte über eine Webseite, die auf der Zentraleinheit abrufbar ist. Die Webseite ist in PHP erstellt worden. Für spezielle Funktionen wird JavaScript verwendet. Dies ermöglicht auch einen Graphen, der einen Verlauf anzeigen kann. Des Weiteren ist es auch Möglich, auf eine angeschlossene Webkamera zuzugreifen. Eine Benutzerverwaltung ist insoweit implementiert, dass eine Registrierung notwendig ist um Daten zu sehen oder Einstellungen vorzunehmen. Eine feinere Unterscheidung wird nicht vorgenommen.
(Aktuell laut Word 155 Wörter)
...
\input{Kapitel/1/Kapitel1.tex}
\newpage

\input{Kapitel/2/Kapitel2.tex}
\newpage

\input{Kapitel/3/Kapitel3.tex}
\newpage

\input{Kapitel/4/Kapitel4.tex}
\newpage

\input{Kapitel/5/Kapitel5.tex}
\newpage
...
%TODO: Hier soll die römische Nummerierung fortgesetzt werden ! Fixen!
