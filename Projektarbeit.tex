...
\newcommand{\AbgabeDatum}{15.05.2017}
...
Die vorliegende Arbeit behandelt das Thema Entwicklung eines Sensorknotens für IoT. Die Idee ist eine Umgebung zu erstellen, in der mehrere Sensorknoten kommunizieren und Messwerte melden. Diese Problemstellung wurde gelöst, indem es eine Zentraleinheit gibt, an die die Sensorknoten ihre Messwerte melden. Als Hardwaregrundlage werden mehrere Raspberry Pi's verwendet, die als unabhängige Sensorknoten arbeiten und einen weiteren Raspberry Pi, der als Zentraleinheit fungiert. Die Software der Sensorknoten ist in Phyton realisiert. Damit die Daten der Sensorknoten verwendet werden können, werden sie in einer MySQL-Datenbank abgelegt. Dargestellt werden die einzelnen Messwerte über eine Webseite, die auf der Zentraleinheit abrufbar ist. Die Webseite ist in PHP erstellt worden. Für spezielle Funktionen wird JavaScript verwendet. Dies ermöglicht auch einen Graphen, der einen Verlauf anzeigen kann. Des Weiteren ist es möglich, auf eine angeschlossene Webkamera zuzugreifen. Eine grundlegende Benutzerverwaltung ist implementiert, sodass eine Registrierung notwendig ist um Daten zu sehen oder Einstellungen vorzunehmen.
